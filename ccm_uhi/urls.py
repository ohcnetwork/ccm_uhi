...
from ccm_uhi.api.emergency_resource_request import EmergencyResourceRequestView
...
urlpatterns = [
    ...
    path("emergency_request/", EmergencyResourceRequestView.as_view(), name="emergency_resource_request"),
] + router.urls
