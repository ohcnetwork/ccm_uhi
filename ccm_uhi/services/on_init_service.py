"""
OnInitService: COMMENTED OUT — logic moved to OnConfirmService.

This module's responsibilities (patient resolution/creation, draft booking
via lock_create_appointment) are now handled in on_confirm_service.py as
part of the merged init+confirm flow.
"""
